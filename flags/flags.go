...
var (
	...
	DisableTLSUprobes = kingpin.Flag("disable-tls-uprobes", "Disable TLS uprobes while keeping L7 tracing for plaintext traffic").Default("false").Envar("DISABLE_TLS_UPROBES").Bool()
